...
namespace Chraft.Net {
    public class PacketWriter {
        ...
        public MemoryStream UnderlyingStream { get { return _Stream; } set { _Stream = value; } }
        private Queue<byte[]> _Strings;
        public Queue<byte[]> Strings { get { return _Strings; } set { _Strings = value; } }
        ...
        public static PacketWriter CreateInstance(int capacity) {
            ...
            if (pw == null) pw = new PacketWriter(capacity);
            return pw;
        }

        public static void ReleaseInstance(PacketWriter pw) {
            if (!_Pool.Contains(pw)) _Pool.Push(pw);
            else {
                try {
        ...
        public void Write(string data) {
            ...
            else b = ASCIIEncoding.BigEndianUnicode.GetBytes(data);
            Write((short)length);
            Write(b, 0, b.Length);
        }
        ...
        public void WriteIntArray(int[] array) {
            foreach (int i in array) Write(i);
        }
